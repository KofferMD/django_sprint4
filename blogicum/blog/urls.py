...
urlpatterns = [
    ...
    path('profile/edit_profile/<str:username>/', views.ProfileUpdateView.as_view(), name='edit_profile'),
    ...
    path('posts/<int:post_pk>/edit/<int:comment_pk>.', views.CommentUpdateView.as_view() ,name='edit_comment'),
